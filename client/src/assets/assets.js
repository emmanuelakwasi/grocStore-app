...
import fabric_image from "./fabrics.jpg";
import  appliance from "./appliances.png";
...
export const categories = [
  ...
  {
    text: "Culture & Seasonal",
    path: "Culture & Seasonal",
    image: africa,
    bgColor: "",
  },
  {
    text: "Appliances & Gadgets",
    path: "Appliances & Gadgets",
    image: appliance,
    bgColor: "#AF9FC9",
  },
  {
...
export const features = [
  ...
  },
  {
    ...
    description: "We source only the freshest fruits, vegetables, and groceries.",
  },
  {
    icon: trust_icon,
