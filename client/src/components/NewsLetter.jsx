const NewsLetter = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center space-y-2 mt-24 pb-14">
            <h1 className="md:text-4xl text-2xl font-semibold">Stay connected with the flavors of Africa.</h1>
            <p className="md:text-lg text-gray-500/70 pb-8">
                Sign up for fresh updates, exclusive offers, and new arrivals from Lovely Queen African Mart.
            </p>
